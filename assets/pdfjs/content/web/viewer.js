          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              loadingTask.onProgress = function (_ref) {
                ...
                //highlight the text after pdf fully loaded
                if(loaded == total){
                    ...
                    debugger
                      if (result != null || result != undefined) {
                          ...
                          chrome.runtime.sendMessage({
                              ...
                              function(tags) {
                                var current_url =  window.location.href.replace("chrome-extension://nbimgbgchmccioidaopfhokkongfhkoe/","");
                                  $.each(result, function(index, value) {
                                      if (value[5] == current_url) {
                                          $.each(tags, function(index, tag) {
                                              if (tag[0] == value[1]) {
                                                console.log(value[0]);
                                                PDFViewerApplication.findController.executeCommand('findhighlightallchange', {
                                                  query: value[0],
                                                  type: ' ',
                                                  phraseSearch: true,
                                                  caseSensitive: false,
    ...
    value: function _renderMatches(matches) {
      ...
      function appendTextToDiv(divIdx, fromOffset, toOffset, className) {
        ...
        if (className) {
          ...
          if(window.color){
            span.style.background = window.color;
          }
      ...
      for (var i = i0; i < i1; i++) {
        ...
        if (begin.divIdx === end.divIdx) {
          ...
          for (var n0 = begin.divIdx + 1, n1 = end.divIdx; n0 < n1; n0++) {
            ...
            textDivs[n0].style.background = window.color;
          }
  ...
  chromeFileAccessOverlayPromise.then(function () {
    ...
    document.getElementById('chrome-file-fallback').onchange = function () {
      ...
      if (file) {
        ...
        callback(_pdfjsLib.URL.createObjectURL(file), file.size, originalUrl);
        overlayManager.close('chromeFileAccessOverlay');
      }
    };
